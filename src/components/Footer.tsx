...
const footerLinks = {
   product: [
      { label: "Explore Reports", href: "/explore" },
      { label: "New Analysis", href: "/items/add" },
      { label: "My Reports", href: "/items/manage" },
      { label: "AI Assistant", href: "/help" },
   ],
   company: [
      ...
      <footer className="border-t bg-background">
         <div className="mx-auto max-w-7xl px-4 py-12">
               ...
               <div className="lg:col-span-2">
                  <Link href="/" className="flex items-center gap-2">
                     ...
                     <span className="text-xl font-bold tracking-tight">
                        DataNav<span className="text-primary">AI</span>
                     </span>
                  </Link>
                  <p className="mt-3 max-w-xs text-sm text-muted-foreground">
                     Upload your data, get AI-powered insights in minutes. Trends, KPIs, and risks — explained in plain language.
                  </p>
                  <div className="mt-4 flex gap-3">
                     ...
                     <a href="#" className="flex size-9 items-center justify-center rounded-lg border bg-muted/50 text-muted-foreground transition-all hover:bg-primary hover:text-primary-foreground hover:shadow-md hover:shadow-primary/20" aria-label="LinkedIn">
            ...
            <div className="mt-10 border-t pt-6 text-center text-sm text-muted-foreground">
               &copy; {new Date().getFullYear()} DataNav AI. All rights reserved.
            </div>
         </div>
      </footer>
   )
