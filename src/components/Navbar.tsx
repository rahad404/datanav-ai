...
import { Menu, X, Compass, LogOut, User, FilePlus2, FolderKanban, LayoutDashboard } from "lucide-react"
   ...
   return (
      <nav className="sticky top-0 z-50 w-full border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
         <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4">
            ...
            {/* Public links always show. Dashboard/Admin only show once logged in. */}
            ...
            {/* Logged out: Log in / Sign up buttons. Logged in: those disappear, avatar + name take their place. */}
               ...
               {user ? (
                  <DropdownMenu>
                     ...
                     <DropdownMenuContent align="end" className="w-52">
                        ...
                        <DropdownMenuItem asChild>
                           <Link href="/items/manage" className="flex cursor-pointer items-center gap-2">
                              <FolderKanban className="size-4" />
                              <span>My Reports</span>
                           </Link>
                        </DropdownMenuItem>
                        <DropdownMenuItem asChild>
                           <Link href="/items/add" className="flex cursor-pointer items-center gap-2">
            ...
            <div className="border-b bg-background px-4 py-4 md:hidden">
               ...
               {user ? (
                  <div className="flex flex-col gap-3">
                     ...
                     <Link href="/items/manage" onClick={() => setIsOpen(false)}>
                        <Button variant="outline" className="w-full justify-start gap-2">
                           <FolderKanban className="size-4" />
                           My Reports
                        </Button>
                     </Link>
                     <Link href="/items/add" onClick={() => setIsOpen(false)}>
                        <Button variant="outline" className="w-full justify-start gap-2">
                           <FilePlus2 className="size-4" />
                           New Analysis
                        </Button>
