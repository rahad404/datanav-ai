         ...
         <div className="flex flex-col p-6 sm:p-12 xl:p-16">
            ...
            <div className="flex items-center justify-center gap-2 xl:justify-start">
               <div className="bg-primary flex size-9 items-center justify-center rounded-xl shadow-md shadow-primary/20">
                  <BookUser className="size-5 text-primary-foreground" />
               </div>
               <span className="text-lg font-semibold tracking-tight">MediQueue</span>
            </div>

            {/* Main Content Area */}
            <div className="mt-12 flex flex-1 flex-col items-center text-center xl:items-start xl:text-left max-w-md mx-auto xl:mx-0 justify-center">
               {/* 404 Badge */}
               ...
               <div className="mt-10 flex flex-col sm:flex-row items-center gap-3 w-full sm:w-auto">
                  <Button
                     ...
                     className="w-full sm:w-auto h-10 px-5 gap-2 font-medium shadow-sm transition-all hover:opacity-90"
                  >
